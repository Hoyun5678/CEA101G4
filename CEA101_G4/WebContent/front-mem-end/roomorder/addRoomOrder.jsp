...
<link href="https://fonts.googleapis.com/css?family=Raleway" rel="stylesheet">
    ...
    <script src="https://kit.fontawesome.com/9e9b23a627.js" crossorigin="anonymous"></script>
...
<%--     <script src="<%=request.getContextPath() %>/js/front-mem-end/creditcard.js"></script> --%>
    <script src="<%=request.getContextPath() %>/js/front-mem-end/addorder.js"></script>
</head>
<body>
                ...
                <div class="form-content">
                   ...
                   <!--第二頁-->
                    <div class="tab">
                        ...
                        <div class="container preload" style="margin-top: -100px;">
...
function rememberCC(){
	...
	document.getElementById("cardnumber").value="12345678901112";
	document.getElementById("expirationdate").value="0122";
...
$('#sellecttime').datetimepicker({
   ...
   setDate:	        '${roomOrderVO.checkInDate}',  // 起始日
